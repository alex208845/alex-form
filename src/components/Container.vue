<template>
  <el-container class="fm2-container">
      ...
      <el-container>
          ...
          <div class="components-list">
            <template v-if="basicFields.length">
              ...
              <draggable tag="ul"
                ...
                <li v-if="basicFields.indexOf(item.type)>=0"
            ...
            <template v-if="advanceFields.length">
              ...
              <draggable tag="ul"
                ...
                <li v-if="advanceFields.indexOf(item.type) >= 0"
                    class="form-edit-widget-label"
        ...
        <el-container class="center-container"
          ...
          <el-header class="btn-bar"
            ...
            <el-button v-if="upload"
                       type="text"
                       size="medium"
                       icon="el-icon-upload2"
                       @click="handleUpload">{{$t('fm.actions.import')}}</el-button>
            ...
            <el-button v-if="generateJson"
                       type="text"
                       size="medium"
                       icon="el-icon-tickets"
                       @click="handleGenerateJson">{{$t('fm.actions.json')}}</el-button>
            <el-button v-if="generateCode"
                       type="text"
                       size="medium"
          ...
          <el-container>
            <el-header height="45px">
              <div class="config-tab"
                   ...
                   @click="handleConfigSelect('widget')">{{$t('fm.config.widget.title')}}</div>
              <div class="config-tab"
                   :class="{active: configTab=='form'}"
                   @click="handleConfigSelect('form')">{{$t('fm.config.form.title')}}</div>
            </el-header>
        ...
        <cus-dialog :visible="previewVisible"
          ...
          <generate-form insite="true"
            ...
            <template v-slot:blank="scope">
              Width <el-input v-model="scope.model.blank.width"
                        style="width: 100px"></el-input>
              Height <el-input v-model="scope.model.blank.height"
                        style="width: 100px"></el-input>
            </template>
          </generate-form>
          ...
          <template slot="action">
            <el-button type="primary"
                       @click="handleTest">{{$t('fm.actions.getData')}}</el-button>
            <el-button @click="handleReset">{{$t('fm.actions.reset')}}</el-button>
          </template>
        </cus-dialog>

        <cus-dialog :visible="uploadVisible"
                    ...
                    form>
          <el-alert type="info"
                    :title="$t('fm.description.uploadJsonInfo')"></el-alert>
          <div id="uploadeditor"
               style="height: 400px;width: 100%;">{{jsonEg}}</div>
        </cus-dialog>
        ...
        <cus-dialog :visible="codeVisible"
          ...
          <el-tabs type="border-card"
            ...
            <el-tab-pane label="Vue Component"
                         name="vue">
              <div id="vuecodeeditor"
                   style="height: 500px; width: 100%;">{{vueTemplate}}</div>
            </el-tab-pane>
    ...
    <el-footer height="30px"
               style="font-weight: 600;">Powered by <a target="_blank">alex</a></el-footer>
  </el-container>
